                    ...
                    <div class="space-y-6">
                        <div class="flex space-x-3 items-center">
                            <div class="space-y-2 w-1/3">
                                ...
                                <input type="text" name="libelle" id="libelle"  value="{{ old('libelle', $produit->libelle ?? '') }}" class="border-gray-300 rounded-md w-full">
                            </div>
                            <div class="space-y-2 w-1/3">
                                <label  class=" text-white " for="quantite">Quantité</label>
                                <input type="number" name="quantite" id="quantite"  value="{{ old('quantite', $produit->quantite ?? '') }}" class="border-gray-300 rounded-md w-full">
                            </div>
                        </div>
                        <div class="flex space-x-3 items-center">
                            <div class="space-y-2 w-1/3">
                                <label  class=" text-white " for="prix">Prix</label>
                                <input type="number" name="prix" id="prix" value="{{ old('prix', $produit->prix ?? '') }}" class="border-gray-300 rounded-md w-full">
                            </div>
                        </div>
                        <div class="flex space-x-3 items-center">
